 ...
 */
export function pascomHandler(addressBooks, settingsPascom) {
 ...
 */
export function pascomCsvHandler(addressBooks, settingsPascomCsv) {
    console.log('PascomCsv: start');
    let pascomCsvPromises = Promise.resolve(true);
...
function pascomCsvProcessCard(vcf, fullname, prefix, duplicates, uniqueEntries) {
    ...
    let numberHome = telephony.home.length > 0 ? telephony.home[0] : "";
    let numberMobile = telephony.mobile.length > 0 ? telephony.mobile[0] : "";
    let numberWork = telephony.work.length > 0 ? telephony.work[0] : "";
    ...
    // reduce to single number per type
    let faxHome = faxes.home.length > 0 ? faxes.home[0] : "";
    let faxWork = faxes.work.length > 0 ? faxes.work[0] : "";
    ...
    // reduce to single number per type
    let emailHome = emails.home.length > 0 ? emails.home[0] : "";
    let emailWork = emails.work.length > 0 ? emails.work[0] : "";
    return {

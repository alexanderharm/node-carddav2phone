 ...
 * @param settingsSnom
 */
export function snomHandler(addressBooks, settingsSnom) {
...
function snomXcapHandler(addressBooks, settingsSnomXcap) {
    ...
    for (let i = 0; i < settingsSnomXcap.telephoneBooks.length; i++) {
        ...
        let data = xml(snomXcapProcessCards(telephoneBook, addressBooks), { declaration: true });
 ...
 */
export function snomTbookHandler(addressBooks, settingsSnomTbook) {
    console.log('SnomTbook: start');
    let snomTbookPromises = Promise.resolve(true);
    // loop over all telephone books
    for (let i = 0; i < settingsSnomTbook.telephoneBooks.length; i++) {
        ...
        let data = xml(snomTbookProcessCards(telephoneBook, addressBooks), { declaration: true });

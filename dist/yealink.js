 ...
 */
export function yealinkHandler(addressBooks, settingsYealink) {
    console.log('Yealink: start');
    let yealinkPromises = Promise.resolve(true);
    ...
    for (let i = 0; i < settingsYealink.telephoneBooks.length; i++) {
        ...
        let data = xml(yealinkProcessCards(telephoneBook, addressBooks), { declaration: true });
